...
if (nextSessionNum==1) && (nextTrialNum==1) % Experiment has not started yet
    ...
    deltaPowerVsTimeList_valid    = []; % For (1)Valid trials:    Delta alpha power as a function of time 
    deltaPowerVsTimeList_invalid  = []; % For (2)Invalid trials:  Delta alpha power as a function of time 
    deltaPowerVsTimeList_constant = []; % For (3)Constant trials: Delta alpha power as a function of time 
