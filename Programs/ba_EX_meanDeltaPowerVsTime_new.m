...
function [PlotH,colorNames,meanEyeOpenPowerList,...
          ...
          = ba_EX_meanDeltaPowerVsTime_new(subjectName,folderName,...
...
%                         if subInd == 1 || subInd == 17 || subInd == 21
...
%                         else
%                             text(0.6,0.3,num2str(mean(EX_mean_deltaPowerVsTimeList_valid),'%.2f'),'Color',colorNames(i),'fontsize',fontSizeVal,'fontweight','bold','unit','normalized','parent',plotH_deltaPowerVsTime);
%                         end
...
%                         else
%                             text(0.6,0.2,num2str(mean(EX_mean_deltaPowerVsTimeList_invalid),'%.2f'),'Color',colorNames(i),'fontsize',fontSizeVal,'fontweight','bold','unit','normalized','parent',plotH_deltaPowerVsTime);
%                         end
                    case 3
...
%                         if subInd == 1 || subInd == 17 || subInd == 21
%                             text(0.05,0.7,num2str(mean(mean_deltaPowerVsTimeList_constant),'%.2f'),'Color',colorNames(i),'fontsize',fontSizeVal,'fontweight','bold','unit','normalized','parent',plotH_deltaPowerVsTime);
%                         else
%                             text(0.6,0.1,num2str(mean(mean_deltaPowerVsTimeList_constant),'%.2f'),'Color',colorNames(i),'fontsize',fontSizeVal,'fontweight','bold','unit','normalized','parent',plotH_deltaPowerVsTime);
%                         end
%                     otherwise 
                end               
