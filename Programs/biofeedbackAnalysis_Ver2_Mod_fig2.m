...
% Updates for Fig2:
% Removed displayflag as bacause we only want to extarct out the data.
% In near future update the 

function [meanEyeOpenPowerList,semEyeOpenPowerList,meanEyeClosedPowerList,semEyeClosedPowerList,calibrationPowerList,trialTypeList1D,timeVals,typeNameList] = biofeedbackAnalysis_Ver2_Mod_fig2(subjectName,folderName)
