...
function biofeedbackFigure_1(subjectName,folderName)
    ...
    hTFPlot           = getPlotHandles(2,1,[0.05 0.1 0.28 0.67],0.01,0.04,0);
    ...
    rectangle(gca,'Position',[0 0 0.1 0.1],'FaceColor','g','EdgeColor','g',...
        'LineWidth',1); axis(gca,'equal'); set(gca,'Visible','off');
    text(gca,0.83,0.65,'Invalid','Units','Normalized','fontsize',fontSizeVal,'fontweight','bold');
    hConstantText   = getPlotHandles(1,1,[0.88 0.95 0.04 0.02]);
    rectangle(gca,'Position',[0 0 0.1 0.1],'FaceColor','b','EdgeColor','b',...
        'LineWidth',1); axis(gca,'equal'); set(gca,'Visible','off');
    text(gca,0.84,0.65,'Constant','Units','Normalized','fontsize',fontSizeVal,'fontweight','bold');
    ...
    set(hFreqVsTime,'xticklabelmode','manual','xtick',[5 10:5:45 50],'xticklabel',[],'xlim',[5 50],'linewidth',4);
    ...
    set(hPowervsTime,'xticklabelmode','manual','xtick',[5 10:5:45 50],'xticklabel',[5 10:5:45 50],'xlim',[5 50]);
