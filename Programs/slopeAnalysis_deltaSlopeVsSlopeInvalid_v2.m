...
scatterColor = jet(length(sl_InvalidTrials)); dotSize = 40;
scatter(hdeltaSlopeVsSlopeInvalid,sl_InvalidTrials,deltaSl_valid_M_invalid,dotSize,scatterColor,'filled');
