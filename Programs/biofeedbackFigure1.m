...
%     hChInAlphaPowerVsTrialtypes = axes('Position', [0.8 0.5 0.15 0.2]); % position for  within the figure 2
    ...
    xlim(hExperimentFlow,[1,61]);  ylim(hExperimentFlow,[-2,2]);    xlabel(hExperimentFlow,'Trial No');
...
%     set(cBar,'fontsize',fontsize,'fontweight','bold');
    ...
    ylabel(cBar,'\DeltaPower(dB)','fontsize',fontsize,'fontweight','bold');
...
%     set(hPowervsTime,'fontsize',fontsize,'fontweight','bold');
    ylabel(gca,'Change In Power (dB)','fontsize',fontsize,'fontweight','bold');
    xlabel(gca,'Time (s)','fontsize',fontsize,'fontweight','bold');
    
    yyaxis(gca,'right');
    plot(gca,timeValsTF(6:end),stFreqList);
    ylabel(gca,'Tone Frequency (Hz)','fontsize',fontsize,'fontweight','bold');
    xlim(gca,[5 50]);
    hold(gca,'off');
...
%     title(analysisPlotHandles.powerVsTime,['Subject',num2str(i)]);
    ...
    ylabel(analysisPlotHandles.powerVsTime,'\Delta Alpha Power (dB)','fontsize',fontsize,'fontweight','bold');
    xlabel(analysisPlotHandles.barPlot,'TrialTypes','fontsize',fontsize,'fontweight','bold');
    ylabel(analysisPlotHandles.barPlot,'\Delta Alpha Power (dB)','fontsize',fontsize,'fontweight','bold');   
